...
## Notes
Clarifying comments or explanatory details

## References
Specific citations (books, news, papers) verifying factual claims made in the article.

## Further reading
Full bibliographic citations (Author, Title, Publisher, Year, ISBN).
Recommended books, academic papers, or articles about the topic.

##  External links
Clean list of active hyperlinks with short descriptive labels.
Hyperlinks to authoritative off-site web resources.Official websites, web portals, public databases, or digital archives.